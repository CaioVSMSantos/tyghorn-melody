...
import { noteToMidi, isBlackKey } from "../shared/note-utils.js";
...
export function renderKeyboardDiagram(container, options = {}) {
    ...
    container.innerHTML = '';
    container.classList.add('keyboard-diagram');
    if (compact) container.classList.add('keyboard-diagram--compact');
