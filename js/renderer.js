...
import { noteNumberToName } from "./midi.js";
...
/**
 * Verifica se um número MIDI é uma nota C.
 */
function isCNote(midiNote) {
...
function createRenderer(canvas, options = {}) {
    ...
    function render(playerState) {
        ...
        if (playerState.finished) {
            ...
            ctx.fillStyle = pct >= 80 ? COLORS.noteHit : pct >= 50 ? COLORS.hitLine : "#ff2a6d";
