...
- **Sem design system complexo** — Não há necessidade de component library, tokens elaborados ou sistemas de grid avançados. CSS direto e funcional.
...
> **Nota:** Os valores hex são uma proposta inicial. Serão ajustados conforme teste visual na implementação real. Contraste de acessibilidade (WCAG) deve ser verificado especialmente para texto sobre fundos escuros.
